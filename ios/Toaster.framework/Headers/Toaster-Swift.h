...
+ (Toast * _Nonnull)makeText:(NSString * _Nullable)text delay:(NSTimeInterval)delay duration:(NSTimeInterval)duration position:(NSString * _Nonnull)position addedOffsetY:(CGFloat)addedOffsetY SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use 'init(text:delay:duration:)' instead.");
+ (void)hide;
- (void)show;
- (void)cancel;
- (void)start;
